...
int main() {
  ...
  tachyon_bn254_fq2 fq2_inverted;
  tachyon_bn254_fq2_inv(&fq2_element, &fq2_inverted);
  ...
  tachyon_bn254_fq6 fq6_inverted;
  tachyon_bn254_fq6_inv(&fq6_element, &fq6_inverted);
  ...
  tachyon_bn254_fq12 fq12_inverted;
  tachyon_bn254_fq12_inv(&fq12_element, &fq12_inverted);

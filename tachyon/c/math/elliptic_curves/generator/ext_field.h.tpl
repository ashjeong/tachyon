/**
 * @file
 * @brief Defines operations over the finite field extension Fq%{degree} for the
 * %{type} curve.
 *
 * This header file specifies the structure and operations for elements of the
 * extended finite field Fq%{degree}, which is built over the base field
 * Fq%{base_field_degree} as part of the %{type} elliptic curve cryptographic
 * operations. It includes basic arithmetic operations such as addition,
 * subtraction, multiplication, and inversion, as well as comparison operations.

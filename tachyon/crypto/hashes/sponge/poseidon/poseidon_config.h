...
struct PoseidonConfig : public PoseidonConfigBase<Params> {
  ...
  constexpr static PoseidonConfig CreateCustom(size_t skip_matrices) {
    PoseidonConfigEntry config_entry(Params::Rate, Params::Alpha,
                                     Params::FullRounds, Params::PartialRounds,
                                     skip_matrices);
    ...
    OptimizeARK<Params::FullRounds, Params::PartialRounds>(ret.mds, ret.ark);
    ComputeSparseMatrices<Params::PartialRounds>(ret.mds, ret.pre_sparse_mds,
  ...
  bool IsValid() const override {
    bool ret =
        ...
        static_cast<size_t>(mds.rows()) == Params::Rate + Params::Capacity &&
        static_cast<size_t>(mds.cols()) == Params::Rate + Params::Capacity &&
        static_cast<size_t>(pre_sparse_mds.rows()) ==
            Params::Rate + Params::Capacity &&
        static_cast<size_t>(pre_sparse_mds.cols()) ==
            Params::Rate + Params::Capacity &&
        sparse_mds_matrices.size() == Params::PartialRounds;
    if (!ret) return false;
